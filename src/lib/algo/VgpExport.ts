...
function createPrefabObjects(lifetime: number, depth: number, hit: boolean, coloredRects: ColoredRect[], seed: number): PrefabObject[] {
...
function createPrefabObject(
  ...
  position: Vec2,
  scale: Vec2,
  color: IndexedColor): PrefabObject {
